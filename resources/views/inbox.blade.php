        ...
        <div class="max-w-7xl mx-auto p-6">
            ...
            @if($appliedVacancies->isEmpty())
                <div class="bg-[#E2ECC8] p-6 rounded-lg shadow-md">
                    <p class="text-lg font-bold text-[#2E342A]">Je hebt nog niet op een vacature gesolliciteerd.</p>
                </div>
            @else
                <div class="bg-[#E2ECC8] p-6 rounded-lg shadow-md">
                    <table class="w-full border-collapse">
                        ...
                        <tr>
                            ...
                            <th class="border border-gray-300 px-6 py-3 text-lg font-bold text-[#2E342A]">Locatie</th>
                            <th class="border border-gray-300 px-6 py-3 text-lg font-bold text-[#2E342A]">Details</th>
                            <th class="border border-gray-300 px-6 py-3 text-lg font-bold text-[#2E342A]">Acties</th>
                        </tr>
                        </thead>
                        <tbody>
        ...
        <div><strong>Land:</strong> {{ $land }}</div>
                                ...
                                <td class="border border-gray-300 px-6 py-3 text-center">
                                    <a href="{{ route('vacancy.show', $vacancy->id) }}"
                                       class="inline-block bg-[#AA0160] hover:bg-[#8C004E] text-white font-semibold text-sm px-6 py-3 rounded-md shadow-md transition duration-300">
                                        Bekijk Details
                                    </a>
                                </td>
                                <td class="border border-gray-300 px-6 py-3 text-center">
